...
public class JohnRosarHashSet <E> implements Collection<E> {
	...
	public JohnRosarHashSet() {  
		this(DEFAULT_INITIAL_CAPACITY, DEFAULT_MAX_LOAD_FACTOR);    
	}

	/** Construct a set with the specified initial capacity and 
	 * default load factor */
	public JohnRosarHashSet(int initialCapacity) { 
		this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);    
	}

	/** Construct a set with the specified initial capacity 
	 * and load factor */
	public JohnRosarHashSet(int initialCapacity, float loadFactorThreshold) { 
	...
	private class MyHashSetIterator implements java.util.Iterator<E> {
		...
		private JohnRosarHashSet<E> set;

		/** Create a list from the set */
		public MyHashSetIterator(JohnRosarHashSet<E> set) {
			this.set = set;
			list = setToList();
		}
