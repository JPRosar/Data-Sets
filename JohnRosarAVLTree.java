...
public class JohnRosarAVLTree<E> extends JohnRosarBinarySearchTree<E> {
  /** Create an empty AVL tree using a natural comparator*/
  public JohnRosarAVLTree() { // super() is implicitly called
  }

  /** Create a JohnRosarBinarySearchTree with a specified comparator */
  public JohnRosarAVLTree(java.util.Comparator<E> c) {
    super(c);
  }

  /** Create an AVL tree from an array of objects */
  public JohnRosarAVLTree(E[] objects) {
    super(objects);
  }
  ...
  protected static class AVLTreeNode<E> extends JohnRosarBinarySearchTree.TreeNode<E> {
