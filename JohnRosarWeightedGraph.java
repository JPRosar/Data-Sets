...
public class JohnRosarWeightedGraph<V> extends JohnRosarUnweightedGraph<V> {
	/** Construct an empty */
	public JohnRosarWeightedGraph() {
	}

	/** Construct a JohnRosarWeightedGraph from vertices and edged in arrays */
	public JohnRosarWeightedGraph(V[] vertices, int[][] edges) {
		createWeightedGraph(java.util.Arrays.asList(vertices), edges);
	}

	/** Construct a JohnRosarWeightedGraph from vertices and edges in list */
	public JohnRosarWeightedGraph(int[][] edges, int numberOfVertices) {
	...
	/** Construct a JohnRosarWeightedGraph for vertices 0, 1, 2 and edge list */
	public JohnRosarWeightedGraph(List<V> vertices, List<WeightedEdge> edges) {
		createWeightedGraph(vertices, edges);
	}

	/** Construct a JohnRosarWeightedGraph from vertices 0, 1, and edge array */
	public JohnRosarWeightedGraph(List<WeightedEdge> edges,
	...
	private void createWeightedGraph(List<V> vertices, int[][] edges) {
		...
		for (int i = 0; i < edges.length; i++) {
			neighbors.get(edges[i][0]).addAll(
					(Collection<? extends Edge>) new WeightedEdge(edges[i][0], edges[i][1], edges[i][2]));
		}
	}
	...
	private void createWeightedGraph(
		...
		for (WeightedEdge edge: edges) {      
			neighbors.get(edge.u).addAll((Collection<? extends Edge>) edge); // Add an edge into the list
		}
	}
	...
	/** MST is an inner class in JohnRosarWeightedGraph */
	...
	/** ShortestPathTree is an inner class in JohnRosarWeightedGraph */
