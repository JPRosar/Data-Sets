...
public class JohnRosarUnweightedGraph<V> implements JohnRosarGraph<V> {
	protected List<V> vertices = new ArrayList<>(); // Store vertices
	protected List<List<Edge>> neighbors 
	= new ArrayList<>(); // Adjacency lists

	/** Construct an empty graph */
	public JohnRosarUnweightedGraph() {
	}

	/** Construct a graph from vertices and edges stored in arrays */
	public JohnRosarUnweightedGraph(V[] vertices, int[][] edges) {
	...
	public JohnRosarUnweightedGraph(List<V> vertices, List<Edge> edges) {
	...
	public JohnRosarUnweightedGraph(List<Edge> edges, int numberOfVertices) {
	...
	public JohnRosarUnweightedGraph(int[][] edges, int numberOfVertices) {
		for (int i = 0; i < numberOfVertices; i++) 
			addVertex((V)(new Integer(i))); // vertices is {0, 1, ...}
